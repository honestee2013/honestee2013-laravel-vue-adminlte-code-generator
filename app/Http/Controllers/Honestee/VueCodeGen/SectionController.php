...
class SectionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(Str::plural($request->query('all', ''))){
            $result = Section::all();
            return $this->sendResponse($result, 'Sections list ');
        }
        ...
        if($sortField)
            $sections = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $sections = $query->paginate( $perPage );
  
        return $this->sendResponse($sections, 'Sections list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$sections');
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Sections' ));
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->sendResponse($section, 'Section Information has been updated');
    }
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            Section::whereIn('id', $idsArray)->delete();
