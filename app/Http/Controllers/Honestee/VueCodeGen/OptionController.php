...
class OptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(Str::plural($request->query('all', ''))){
            $result = Option::all();
            return $this->sendResponse($result, 'Options list ');
        }
        ...
        if($sortField)
            $options = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $options = $query->paginate( $perPage );
  
        return $this->sendResponse($options, 'Options list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$options');
    ...
    public function store(Request $request)
    {
        ...
        if($model_id && $relation &&  $pv_ids){ // Many to Many relationships
            ...
            return $this->sendResponse( $option, 'Option Created Successfully');
        }
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Options' ));
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->sendResponse($option, 'Option Information has been updated');
    }
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            Option::whereIn('id', $idsArray)->delete();
