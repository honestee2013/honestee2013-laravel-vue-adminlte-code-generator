...
use App\Models\Honestee\VueCodeGen\Part;
...
class PartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($sortField)
            $parts = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $parts = $query->paginate( $perPage );
  
        return $this->sendResponse($parts, 'Parts list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$parts');
    ...
    public function store(Request $request)
    {
        ...
        if($model_id && $relation &&  $pv_ids){ // Many to Many relationships
            ...
            return $this->sendResponse( $part, 'Part Created Successfully');
        }
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Parts' ));
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->sendResponse($part, 'Part Information has been updated');
    }
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            Part::whereIn('id', $idsArray)->delete();
