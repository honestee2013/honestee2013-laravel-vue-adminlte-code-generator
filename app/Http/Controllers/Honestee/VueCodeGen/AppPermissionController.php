...
use App\Models\Honestee\VueCodeGen\Permission;
...
//exit("xxxxxxxxxx ".$request->query('n', ''));
return $this->sendResponse(Permission::all(), 'Permissions list '.$request->query('n', ''));
        ...
        if($sortField)
            $permissions = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$permissions');
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Permissions' ));
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            Permission::whereIn('id', $idsArray)->delete();
