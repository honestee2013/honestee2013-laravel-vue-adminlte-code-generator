<template>
  <section class="content">
          ...
          >
              <section  id = "printPaper" slot="pdf-content" style=" width:100%; background-color: white;  padding: 0% 0.5% 40% 0.5%;">
                <div style = "margin-left: 0; width: 100%; ">
                  <h3 style="text-align:center; text-decoration: underline; padding: 1em; "> Part Lists</h3>
                  <table class="table table-bordered" style="width: 100%; ">
                        <thead>
                            <tr>
                                                                                                                                                              <th>Name</th>
                                                                                                                                <th>Identify Classroom</th>
                                                                                                                                                                                                                      </tr>   
                        </thead>
                        <tbody >
                            <tr v-for="(part, index) in parts" :key="part.id">
                                                                                                                                                                              <td>{{ part.name }} </td>
                                                                                                                                              <td>{{ part.identify_classroom }} </td>
                                                                                                                                                                                                                                        </tr>
                        </tbody>
                  </table>
                </div>
              ...
              <div class="card w-100" v-if="$gate.isAdmin()" > 
                ...
                <div class="card-header pr-sm-3">
                  <div class="d-flex mb-3">
                    <h3 class="card-title mr-auto ">Part List </h3>
                      ...
                      :columns="columns">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <button href="#" class="dropdown-item" @click.prevent="print">
                                      ...
                                      <button href="#" class="dropdown-item">
                                        ...
                                        <json-excel class="" :data="parts" :fields="table_heders" worksheet="Part Lits" name="part_lists.xls">
                          ...
                          <template slot="table-row" slot-scope="props">
                            <span v-if="props.column.field == 'action'">
                              <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary"  @click="partDetail(props)">Detail</button>
                                ...
                                <div class="dropdown-menu">
                                  <!--<a class="dropdown-item" href="#" @click="partDetail('show')"><i class="fa fa-eye"> <span style="margin-left:0.1em"> Details </span> </i></a>
                                  <div class="dropdown-divider"></div>-->
                                  <a class="dropdown-item" href="#" @click="editModal(props.row)"><i class="fa fa-edit">  <span style="margin-left:0.1em"> Edit </span>  </i></a>
                                  <a class="dropdown-item " href="#" @click="deletePart(props.row.id)"><i class="fa fa-trash">  <span style="margin-left:0.1em"> Delete </span>  </i></a>
                                </div>
                              </div>
                            </span>
                            <span v-else>
                          ...
                          <div slot="selected-row-actions">
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item " href="#" @click="deleteSelectedParts()"><i class="fa fa-trash">  <span style="margin-left:0.1em"> Delete </span>  </i></a>
                                  </div>
                                </div>
                          </div>
                    </vue-good-table>
                ...
                <div class="card-footer">
                    <!--<pagination :data="parts" @pagination-change-page="getResults"></pagination>-->
                </div>
              </div> <!-- /.card ends-->
          </div> <!-- /.row ends-->
        </div> <!-- /.container ends-->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header"> <!-- Modal Header -->
                      <h5 class="modal-title" v-show="!editmode">New Part</h5>
                      <h5 class="modal-title" v-show="editmode">Update Part</h5>
                  ...
                  <form @submit.prevent="editmode ? updatePart() : createPart()">
                    <div class="modal-body">
                                  ...
                                  <select v-model="form.name" name="name" class="form-control" :class="{ 'is-invalid': form.errors.has( 'name' ) }">
                                                      ...
                                                      <div class="form-group">
                                                                <label>Identify classroom</label>
                                  <select v-model="form.identify_classroom" name="identify_classroom" class="form-control" :class="{ 'is-invalid': form.errors.has( 'identify_classroom' ) }">
                                                                                <option> Using Letters eg JSS One A </option>
                                                                                <option> Using Department eg SSS One Art </option>
                                                                                <option> Using Colors eg Primary One Green </option>
                                                                        </select>
                                                                        <has-error :form="form" field="identify_classroom"></has-error>
        ...
        <!-- Detail Modal -->
        <div class="modal fade" id="partDetail" tabindex="-1" role="dialog" aria-labelledby="partDetail" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header"> <!-- Modal Header -->
                        <h5 class="modal-title" > Part Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div> 
                    ...
                    <div class="modal-footer">
                        ...
                        data-dismiss="modal" 
                        @click="deletePart(clickedRow.id)"><i class="fa fa-trash"></i> Delete </button>
    ...
    export default {
        data () {
            return {
                ...
                table_heders: {
                                                                                                  "Name" : "name",
                                                                                "Identify Classroom" : "identify_classroom",
                                                                                                                                  },
        ...
        methods: {
            ...
            partDetail(params){
              ...
              $('#partDetail').modal('show');
            },

            updatePart(){
                this.$Progress.start();
                // console.log('Editing data');
                this.form.put('api/parts/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                const theData = [id];
                                this.form.delete('api/parts/'+JSON.stringify(theData) ).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                                        'The part was deleted successfully.',
                                        'success'
                                        );
                                    // Fire.$emit('AfterCreate');
                                    this.loadParts();
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                ...
                                this.form.delete('api/parts/'+theData).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                                        'The part was deleted successfully.',
                                        'success'
            ...
            loadParts() {
                ...
                var url = "api/parts"+parameters;
                //console.log(JSON.stringify( url));
                try{
                    this.form.get( url ).then( parts  => {
                        if(parts.data.data){
                          this.totalRecords = parts.data.data.total
                          this.parts = parts.data.data.data;
                        }
                    });
                } catch(error){
