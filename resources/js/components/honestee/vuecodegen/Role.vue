                      ...
                      :columns="columns">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <button href="#" class="dropdown-item" @click.prevent="print">
                                      ...
                                      <button href="#" class="dropdown-item">
                                        ...
                                        <json-excel class="" :data="roles" :fields="table_heders" worksheet="Role Lits" name="role_lists.xls">
                            ...
                            <span v-if="props.column.field == 'action'">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item " href="#" @click="deleteRole(props.row.id)"><i class="fa fa-trash">  <span style="margin-left:0.1em"> Delete </span>  </i></a>
                                </div>
                              </div>
                            </span>
                            <span v-else>
                          ...
                          <div slot="selected-row-actions">
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item " href="#" @click="deleteSelectedRoles()"><i class="fa fa-trash">  <span style="margin-left:0.1em"> Delete </span>  </i></a>
                                  </div>
                                </div>
                          </div>
                    </vue-good-table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header"> <!-- Modal Header -->
                      <h5 class="modal-title" v-show="!editmode">New Role</h5>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        data-dismiss="modal" 
                        @click="deleteRole(clickedRow.id)"><i class="fa fa-trash"></i> Delete </button>
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                const theData = [id];
                                this.form.delete('api/roles/'+JSON.stringify(theData) ).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                ...
                                this.form.delete('api/roles/'+theData).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                                        'The role was deleted successfully.',
                                        'success'
